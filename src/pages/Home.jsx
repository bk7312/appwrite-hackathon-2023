        ...
        >
            ...
            <div className='hidden container mx-auto rounded bg-blue-50 dark:bg-blue-900' ref={aboutRef}>
                ...
                <div className="container mx-auto py-2 px-4 text-left">
                    ...
                    <p className='p-2'>
                        In more concrete terms, TownSquare is a forum for the residents of any particular area to gather around and post stuff.
                        ...
                        Below are some example use cases for why anyone would want to use the TownSquare.
                    </p>
                    <ol>
                        <li className='p-2 list-decimal list-inside'>
                            ...
                            you advertise in the TownSquare and let all the other residents know!
                        </li>
                        <li className='p-2 list-decimal list-inside'>
                            ...
                            Google search? Of course not, you go around the TownSquare and ask for one!
                        </li>
                        <li className='p-2 list-decimal list-inside'>
                            ...
                            gonna compete? Create an e-commerce store? Of course not, you commission some guy to create this &quot;TownSquare&quot; forum website
